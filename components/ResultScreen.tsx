...
export function ResultScreen({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10 space-y-4">
      <AccordionStep stepNumber={1} title="문의 항목 분류" status="done">
        <CategoryTags mentionedCategoryIds={mentionedCategoryIds} />
      </AccordionStep>

      <AccordionStep stepNumber={2} title="답변 초안 생성" status="done">
        ...
        {hasRisk && !allChecked && (
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-blue-600 text-white rounded-lg px-4 py-2 font-medium hover:bg-blue-700 transition-all duration-150"
            >
              위험 구간 확인하기
            </button>
          </div>

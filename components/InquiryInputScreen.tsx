  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-8">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900" style={{ fontFamily: 'Presentation' }}>바이어 문의 원문 입력</h2>
        ...
        <textarea
          ...
          className="mt-5 w-full rounded-lg border border-gray-200 p-4 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        />
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className={
              canSubmit
                ? "bg-[rgb(98_80_237/77%)] text-white rounded-lg px-5 py-2.5 font-medium hover:bg-[rgb(98_80_237/100%)] transition-all duration-150"
                : "bg-gray-200 text-gray-400 rounded-lg px-5 py-2.5 cursor-not-allowed"
            }
          >
            분석 시작하기
          </button>
